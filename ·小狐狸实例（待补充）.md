...
```c#
 if ( ! Physics2D.OverlapCircle(cellingcheck.position, 0.2f,ground))//判断头顶无障碍下才能起立
 {
     //起立
     if (Input.GetButtonDown("Crouch") && anim.GetBool("Crouching") == true && coll.IsTouchingLayers(ground))
     {
     ...
     //下蹲
     else if (Input.GetButtonDown("Crouch") && anim.GetBool("Crouching") == false && coll.IsTouchingLayers(ground))
     {
